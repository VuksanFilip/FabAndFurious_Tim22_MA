...
public class PassangerRideHistory extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.item1){
            Intent intent = new Intent(PassangerRideHistory.this, PassengerAccountActivity.class);
            startActivity(intent);
        }
        if(id == R.id.item2){
            Intent intent = new Intent(PassangerRideHistory.this, PassengerInboxActivity.class);
            startActivity(intent);
        }
        if(id == R.id.item3){
            Intent intent = new Intent(PassangerRideHistory.this, PassangerRideHistory.class);
            startActivity(intent);
        }
        if(id == R.id.item4){
